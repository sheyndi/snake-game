export const stages = [
    ...
    
    {
        ...
        pipePositions: [
            ...
            { position: 23, type: 'pipe-down-left' },

            { position: 39, type: 'pipe-vertical' },

            { position: 55, type: 'pipe-up-left' },
            { position: 54, type: 'pipe-horizontal' },
            { position: 53, type: 'pipe-horizontal' },
            { position: 52, type: 'pipe-down-right' },
            { position: 68, type: 'pipe-up-right' },
            { position: 69, type: 'pipe-horizontal' },
            { position: 70, type: 'pipe-horizontal' },
            { position: 71, type: 'pipe-horizontal' },
            { position: 72, type: 'pipe-horizontal' },
            { position: 73, type: 'pipe-horizontal' }
        ]
